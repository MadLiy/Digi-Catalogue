document.addEventListener("DOMContentLoaded", function () {
  ...
  btnSituation.addEventListener("click", function () {
    if (
      choiceSituation.style.display === "none" ||
      choiceSituation.style.display === ""
    ) {
  ...
  btnThematic.addEventListener("click", function () {
    if (
      choiceThematic.style.display === "none" ||
      choiceThematic.style.display === ""
    ) {
  ...
  btnNiveau.addEventListener("click", function () {
    if (
      choiceNiveau.style.display === "none" ||
      choiceNiveau.style.display === ""
    ) {
...
document.getElementById("Aimg").addEventListener("click", function () {
  var filtreSection = document.getElementById("filter");
  if (filtreSection.style.display !== "none") {
    filtreSection.style.display = "none";
  } else {
    filtreSection.style.display = "block";
  }
});
